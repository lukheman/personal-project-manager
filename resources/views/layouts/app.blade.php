...
<body>
    ...
    <x-layout.sidebar :brand-name="$brandName" :brand-icon="$brandIcon">
        ...
        <x-layout.sidebar-section title="Project Manager">
            <x-layout.sidebar-link href="{{ route('admin.price-categories') }}" icon="fas fa-tags" :active="request()->routeIs('admin.price-categories')">Kategori Harga</x-layout.sidebar-link>
            <x-layout.sidebar-link href="{{ route('admin.clients') }}" icon="fas fa-user-friends" :active="request()->routeIs('admin.clients')">Clients</x-layout.sidebar-link>
            <x-layout.sidebar-link href="{{ route('admin.projects') }}" icon="fas fa-folder-open" :active="request()->routeIs('admin.projects')">Projects</x-layout.sidebar-link>
            <x-layout.sidebar-link href="{{ route('admin.invoices') }}" icon="fas fa-file-invoice-dollar" :active="request()->routeIs('admin.invoices')">Invoice</x-layout.sidebar-link>
        </x-layout.sidebar-section>

        <x-layout.sidebar-section title="Settings">
